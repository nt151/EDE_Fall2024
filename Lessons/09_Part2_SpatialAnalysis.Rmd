...
We'll focus on just a few variables: - Estimates of people in poverty (`E_POV150`) - Minority population (`E_MINRTY`), - The three major theme indices: - [1] Socioeconomic; - [2] Household; - [3] Racial/Ethnic; and - [4] Housing keeping the location attributes as well.
