...
ggplot(PeterPaul.chem.nutrients, aes()) + geom_bar()
...
# Plot surface temperatures by day of  year. 
 ...
 PeterPaul.chem.nutrients %>% 
  filter(depth == 0) %>% 
  ggplot(aes(x=daynum, y= temperature_C, colour = year4)) +  geom_point()
...
PeterPaul.chem.nutrients %>% 
  ggplot(aes(x=sampledate, y= temperature_C, colour = depth)) +  geom_point(size=0.5)
