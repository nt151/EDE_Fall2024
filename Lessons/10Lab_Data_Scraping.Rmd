...
# Set the URL for the last 24 days of data for gage 02085070
...
electricity_data_2024 <- data.frame(
  State = the_states,
  Retail_Price = as.numeric(the_price),
  Capacity = gsub(",","" the_capacity)),
  Net_Generation = as.numeric(gsub(",","" net_generation)),
  Total_Retail_Sales = as.numeric((gsub(",",""total_retail))
)
view(electricity_data_2024)
