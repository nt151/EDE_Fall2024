...
> Answer: I have prior data analysis skills with Stata, but don't have prior experiance with R and Git. It's my first time using both R and Git. 

2. Are there any components of the course about which you feel confident?

> Answer: I feel confident about understanding the basic structure of the course and navigating the tools we will be using during the class. 

3. Are there any components of the course about which you feel apprehensive?

> Answer: Yes, since it's my first time using R I feel a little bit anxious. however, the professors' clear lectures and instruction give me confidence to work hard and make the most of this opportunity. 
...
> Answer: https://github.com/nt151/EDE_Fall2024
