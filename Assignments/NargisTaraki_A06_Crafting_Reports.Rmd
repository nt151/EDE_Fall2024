...
# Compute mean PM2.5 concentration for each county, rounded to 2 decimal places
...
# Compute mean Ozone concentration for each county, rounded to 2 decimal places
...
---
```{r echo=FALSE, fig.align='left', fig.cap='2018 monthly Ozone levels',fig.align='left' ,fig.height=3, message=FALSE, warning=FALSE}
...
```{r echo=FALSE, fig.align='left', fig.cap='2019 monthly Ozone levels',fig.align='left' ,fig.height=3, message=FALSE, warning=FALSE, eecho=FALSE}
...
## Git Repository
https://github.com/nt151/EDE_Fall2024
